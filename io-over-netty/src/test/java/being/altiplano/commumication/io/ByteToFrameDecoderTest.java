...
class ByteToFrameDecoderTest {
    @Test
    public void testDecodeOnce() {
        EmbeddedChannel channel = new EmbeddedChannel(new ByteToFrameDecoder());
    ...
    public void testDecodeFrameTooBig() {
        ...
        EmbeddedChannel channel = new EmbeddedChannel(new ByteToFrameDecoder(10));
